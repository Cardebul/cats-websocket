    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chats_to', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'chat_room',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='messages', to='app.chatroom')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('achievements', models.ManyToManyField(through='app.AchievementCat', to='app.achievement')),
        ...
        migrations.AddField(
            ...
            name='cat',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.cat'),
        ),
    ]
